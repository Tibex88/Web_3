<template>
    ...
    <div class="text-center p-10 md:pb-0 flex gap-5 flex-col justify-center items-center">
        ...
        <!-- socials -->
        <div class="coutline flex gap-5 text-lg justify-center p-3">
        ...
        <!-- <div class="">
            <div class="outline cw-fit px-6 py-4 flex justify-between">
                <p class="cwhitespace-nowrap">
                    <span class="cwhitespace-nowrap"> Copyright &copy; 2024.</span>
